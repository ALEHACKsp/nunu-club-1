...
if (!str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/profile?id=") && !str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/dashboard") && !str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/admin_menu")) {
	header("Location: https://nunu.club/panel/index.php/dashboard");
}
...
<body>
<?php
if (str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/profile?id=")) {
    ...
    <br style="display: block; content: \'\'; border-bottom: 30px solid transparent;">';
                ...
                while($row = $user_comments->fetch_array(MYSQLI_ASSOC)){
                    ...
                    echo '
                    <a class="user_creator_comment" style="float: left; color:yellow; margin-top: -3px;" href="https://nunu.club/panel/index.php/deletecomment?id=' . $id . '&comment_id=' . $row['id'] . '">🗑️</a>';
                    }
                    echo '
                    <a class="user_creator_comment" href="https://nunu.club/panel/index.php/profile?id=' . htmlentities($row['creator_uid'], ENT_QUOTES, 'UTF-8') . '" style="float: left; color: rgb(200, 200, 200); font-size: 16px; margin-left: 7px;">' . htmlentities($row['creator_username'], ENT_QUOTES, 'UTF-8') . '</a>
                    <br>
    ...
    if (str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/deletecomment?id=")) {
...
if (str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/dashboard")) {
echo '
 ...
 <div class="Div-Dashboard">
	 <h4 style="color:white; position: relative; bottom: 40px;">user profile</h4>
	 <div id="div-table" style="position: absolute; top: 30%; left: -390%; border: 1px solid #353535; border-radius: 5px; overflow-x: hidden; width: 700px; height: 300px; padding: 10px;" class="table-div">
	 	<label style="display: block; color:white; text-align: center;">'; echo'welcome. <a href="https://nunu.club/panel/index.php/profile?id=' . $_SESSION['user_uid'] . '">' . $_SESSION["usernameget"] . '</a> (uid: ' . $_SESSION["user_uid"] . ')</label>
		<hr><br><br>
		<div style="width: 50%; float: left;">
			<label style=" color:white;">sub</label><br>';
}
			?>
			<?php
			if (str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/dashboard")) {
		      $info_sub = mysqli_query($connection, "SELECT license, expire FROM auth WHERE username = '" . $_SESSION["usernameget"] . "';");
		        if ($info_sub) {
		        	$row = mysqli_fetch_array($info_sub);
					    ...
					    if ($expire_days > 0) {
		        			echo '<label style=" color:#00ff00;">' . $expire_diff->days . ' Day(s) ' . $expire_diff->h . ' Hour(s)</label><br><a id="Redeem_Key_Button_Modal">extend</a><br><br>';
		        		} else {
	...
	<div class="stats">
	<div style="height: 0">
		<label style="position: relative; bottom: 35px">stats</label>
	</div>
		<label>registered users: ' . $r_row["total"] . '</label><br>
		<label>newest user: </label><a href="https://nunu.club/panel/index.php/profile?id=' . $nu_ri[0] . '">' . $nu_row["username"] . '</a>
	</div>';
}

if ($_SESSION['usernameget'] === "Nunu" || $_SESSION['usernameget'] === "admin") {
	if (str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/admin_menu/licenses")) {
	...
	if (str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/admin_menu/bans")) {
        ...
        <div class="Div-Options-Admin">
            ...
            <div style="height: 550%; width: 653%; border: 1px solid #353535;border-radius: 5px; position: absolute; top:-120%; transform: translate(-50%, -50%); left:50%;" class="Admin-License-Table">
            <button onclick="history.go(-1);" style="border: none; width: 100%; height: 20px;">Back to Prev Page</button>
	...
	if (str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/admin_menu/users")) {
        ...
        <div class="Div-Options-Admin">
            ...
            <div style="height: 550%; width: 600%; border: 1px solid #353535;border-radius: 5px; position: absolute; top:-120%; transform: translate(-50%, -50%); left:50%;" class="Admin-License-Table">
            <button onclick="history.go(-1);" style="border: none; width: 100%; height: 20px;">Back to Prev Page</button>
            <h4 style="color: white;">User</h4>
            <form method="post">
                <select name="admin_selected_user" size="1" autocomplete="off">';
	...
	if (str_contains($_SERVER['REQUEST_URI'], "/panel/index.php/admin_menu/info_sub")) {
        ...
        <div class="Div-Options-Admin">
            ...
            <form method="post">
                ...
                <button name="admin_get_info" style="width: 75%; height: 30px;">Get information</button>
                </form>
            </div>
        </div>';
	}
...
?>
	<form method="get">
		<button class="btn" name="logout">Logout</button><br>
	</form>
		<a href="https://nunu.club/panel/index.php/admin_menu/users" class="btn">Users</a><br>
		<a href="https://nunu.club/panel/index.php/admin_menu/bans" class="btn">Bans</a><br>
		<a href="https://nunu.club/panel/index.php/admin_menu/info_sub" class="btn">Info Sub</a><br>
		<a href="https://nunu.club/panel/index.php/admin_menu/licenses" class="btn">Licenses</a><br>
        <footer>
            <div class="common_wrapper">
                <nav>
                    ...
                    <a href="https://nunu.club/panel/index.php/faq">FAQ</a>
                    <a href="https://nunu.club/panel/index.php/tos">ToS</a>
